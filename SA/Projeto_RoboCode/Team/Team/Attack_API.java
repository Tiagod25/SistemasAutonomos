...
public final class Atack_API {
    ...
    private static final double GT=0.2; // Weight of the Global Target in the decision;



    public static String nextAttack(AdvancedRobot r){
        TeamLeader me = (TeamLeader) r;
    ...
    private static List<Transfer> getInfosEnemies(TeamLeader r){
