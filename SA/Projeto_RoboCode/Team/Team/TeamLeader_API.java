...
public final class TeamLeader_API {
    ...
    //Weights
    private static final double Wi = 0.48; // Weight isolation
    private static final double Wp = 0.48; // Weight proximity
    ...
    private static List<Pair> getIsolation(TeamLeader r){
    ...
    private static List<Pair> getTeamProximity(TeamLeader r){
        List<Pair> res = new ArrayList<>();
    ...
    private static List<Pair> getEnergy(TeamLeader r){
        List<Pair> res = new ArrayList<>();
    ...
    public static String getTarget(AdvancedRobot r){
        ...
        List<Pair> I = getIsolation((TeamLeader) r);
        List<Pair> P = getTeamProximity((TeamLeader) r);
        List<Pair> E = getEnergy((TeamLeader) r);

        List<Pair> PossibleTargets = new ArrayList<>();
        String None = "None";
        Pair target;

        List<InfoRobot> info_robots = new ArrayList<>(((TeamLeader) r).getEnemies());
